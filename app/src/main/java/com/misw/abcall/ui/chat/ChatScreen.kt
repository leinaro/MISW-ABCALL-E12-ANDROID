    ...
    Row(
        ...
        OutlinedTextField(
            ...
            keyboardOptions = KeyboardOptions.Default.copy(
                imeAction = ImeAction.Send // Configura el botón de acción como "Enviar"
            ),
            keyboardActions = KeyboardActions(
                onSend = {
                    if (textState.text.isNotBlank()) {
                        onSendMessage(textState.text) // Llama a la función de enviar con el texto actual
                        textState = TextFieldValue()  // Limpiar el campo después de enviar
                    }
                }
            ),
            singleLine = true
